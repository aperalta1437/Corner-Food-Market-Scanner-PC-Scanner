...
Public Class StorePurchase
    ...
    Private Sub btnInsertAdd_Click(sender As Object, e As EventArgs) Handles btnInsertAdd.Click
        ...
        Dim query As String = "EXEC usp_ADD_STORE_PURCHASE'" + txtInsertStPurchNum.Text + "', '" + datInsertDate.Text +
                                "', '" + lstInsertPayType.SelectedItem.ToString + "', '" + txtInsertVendorNum.Text + "'"
    ...
    Private Sub StorePurchase_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CenterForm(Me)
    End Sub
End Class